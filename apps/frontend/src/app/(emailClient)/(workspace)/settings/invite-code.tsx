...
export function InviteCodeForm() {
  const {
    inviteCodeIdBeingDeleted: _inviteCodeIdBeingDeleted,
    deleteInviteCode: _deleteInviteCode,
    isDeletingInviteCode: _isDeletingInviteCode,
  ...
  if (userCreatedInviteCodes?.length) {
    ...
    //   </div>
    // );
    InviteCodeBody = <div>hello world</div>;
  }
